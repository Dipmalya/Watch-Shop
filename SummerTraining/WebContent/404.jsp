...
<title>Watches an E-Commerce online Shopping Category Flat Bootstrap Responsive Website Template| 404</title>
	   ...
	   <div class="menu">
	     <ul class="megamenu skyblue">
			...
			<li><a class="color4" href="#">womens</a>
				...
				<li class="active grid"><a class="color7" href="404.jsp">News</a></li>
				<div class="clearfix"> </div>
			</ul>
			</div>
	        <div class="clearfix"> </div>
