...
<title>Watches an E-Commerce online Shopping Category Flat Bootstrap Responsive Website Template| Men</title>
...
<div class="men_banner">
   ...
   <div class="men">
    <div class="container">
    	<div class="col-md-4 sidebar_men">
		  ...
		  <h3>Brand</h3>
    	  <ul class="product-categories color">
			<li class="cat-item cat-item-60"><a href="#">Bretling</a> <span class="count">(2)</span></li>
			<li class="cat-item cat-item-63"><a href="#">Rolex</a> <span class="count">(2)</span></li>
			<li class="cat-item cat-item-54"><a href="#">Omega</a> <span class="count">(8)</span></li>
			<li class="cat-item cat-item-55"><a href="#">Titan</a> <span class="count">(11)</span></li>
			<li class="cat-item cat-item-55"><a href="#">Patek Phillipe</a> <span class="count">(11)</span></li>
			<li class="cat-item cat-item-55"><a href="#">Tag Heurer</a> <span class="count">(11)</span></li>
		  </ul>
		  <h3>Price</h3>
   ...
   <div class="footer">
	    ...
	    <div class="clearfix"></div>
	    <div class="copy">
           <p> &copy; 2015 Watches. All Rights Reserved | Design by <a href="http://www.tensbit.com.com/" target="_blank">Tensbit</a></p>
	    </div>
   	</div>
   </div>
</body>
