...
<title>Watches an E-Commerce online Shopping Category Flat Bootstrap Responsive Website Template| Brands</title>
...
<div class="men_banner">
	   ...
	   <div class="menu">
	     <ul class="megamenu skyblue">
			...
			<li><a class="color4" href="#">womens</a>
				...
				<li class="active grid"><a class="color10" href="brands.jsp">Brands</a></li>
   ...
   <div class="footer">
	    ...
	    <div class="clearfix"></div>
	    <div class="copy">
           <p> &copy; 2015 Watches. All Rights Reserved | Design by <a href="http://www.tensbit.com/" target="_blank">Tensbit</a></p>
	    </div>
   	</div>
   </div>
</body>
